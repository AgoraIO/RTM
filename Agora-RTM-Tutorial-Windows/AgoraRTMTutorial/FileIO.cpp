...
__IMPLEMENT_INICONFIG_FUN(CConfigSignal, LastUploadMediaId, INI_BASEINFO, INI_BASEINFO_UPLOADMEDIAID)
__IMPLEMENT_INICONFIG_FUN(CConfigSignal, LastDownloadMediaId, INI_BASEINFO, INI_BASEINFO_DOWNLOADMEDIAID)